...
In our case we have medical data, so we can use:
  ...
  * Sensitivity – an estimate of the probability that the test will predict the disease, provided that the patient is actually sick.

  * Specificity – an estimate of the probability that the test predicts that the patient is healthy, provided that he or she is in fact healthy.
...
So, the best Logistic regression model when comparing the statistics:
  ...
  * Balanced Accuracy: 1, 5, 8

  * 10-fold CV: 8, 9

  * Bootstrap: 7, 8

To sum up, the best Logistic regression model is the **8th** one: model without variables that are useless from EDA and bag tree imputing method.
...
# QDA ->
# k-NN ->
# Logistic regression -> logit8
# Random tree -> tree6
# Bagging -> btree6
# Boosting -> boost.6
# Random forest -> rf.10

all_statistics <- data.frame(logit8, tree6, btree6, boost.6, rf.10)
...
So, the best model when comparing the statistics:
  ...
  * Sensitivity: Logistic regression, Random forest
