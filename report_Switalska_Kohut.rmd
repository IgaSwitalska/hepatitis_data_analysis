...
# n <- 15
# xrange <- range(df2[n])
# col.false <- rgb(0,1,0,0.5)
# col.true  <- rgb(1,0,0,0.5)
# hist(df[n][df[1] == 1], xlim=xrange, prob=T,col=col.false, main="Histogram of df[15]")
# hist(df2[n][df2[1] == 1], prob=T, col=col.true, add=T)
# legend("topleft", fill=c(col.false, col.true), legend=levels(Churn.))
```
